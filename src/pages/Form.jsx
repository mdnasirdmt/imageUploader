...
const Form = () => {
  ...
  return (
    <>
      <div className="p-12 text-center bg-blue-300 font-bold">
        <h1 className="text-4xl font-bold  text-center bg-white-950 p-6 bg-slate-900 text-white m-5">
          Enter Your Details
        </h1>
        ...
        <div>
          {formDataDisplay && (
            <div className="p-8 text-center bg-light-blue-300 font-bold">
              <h2>Entered Data</h2>
              <ul>
